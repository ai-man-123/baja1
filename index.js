...
╚═══❏ *Aiman - SELF* ❏══❍`
    ...
    case 'get':
            ...
            case 'owner':
            case 'creator':
                  syaa.sendMessage(from, {displayname: "Aiman", vcard: vcard}, MessageType.contact, { quoted: mek})
                  ...
                  syaa.sendMessage(from, ini_buffer, MessageType.image, {quoted: mek, caption: '*https://github.com/ai-man-123'})
                  break
    case 'kontag':
